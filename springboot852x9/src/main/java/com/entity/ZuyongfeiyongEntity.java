 ...
 */
@TableName("zuyongfeiyong")
public class ZuyongfeiyongEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public ZuyongfeiyongEntity() {
		
	}
	
	public ZuyongfeiyongEntity(T t) {
		try {
	 ...
	 * 设置：租车天数
	 */
	public void setZuchetianshu(Integer zuchetianshu) {
		this.zuchetianshu = zuchetianshu;
	}
	/**
	 * 获取：租车天数
	 */
	public Integer getZuchetianshu() {
		return zuchetianshu;
	}
	/**
	 * 设置：租用费用
