...
public class ZulindingdanEntity<T> implements Serializable {
	 ...
	 * 设置：汽车状态
	 */
	public void setQichezhuangtai(String qichezhuangtai) {
		this.qichezhuangtai = qichezhuangtai;
	}
	/**
	 * 获取：汽车状态
	 */
	public String getQichezhuangtai() {
		return qichezhuangtai;
	}
	/**
	 * 设置：账号
	 */
