		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="出租单号" prop="chuzudanhao">
					<el-input v-model="ruleForm.chuzudanhao" placeholder="出租单号" clearable  :readonly="ro.chuzudanhao"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="出租单号" prop="chuzudanhao">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="归还类型" prop="guihaileixing">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="归还类型" prop="guihaileixing">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="租赁时间" prop="zulinshijian">
					<el-input v-model="ruleForm.zulinshijian" placeholder="租赁时间" clearable  :readonly="ro.zulinshijian"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="租赁时间" prop="zulinshijian">
					<el-input v-model="ruleForm.zulinshijian" placeholder="租赁时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="归还时间" prop="guihaishijian">
					<el-input v-model="ruleForm.guihaishijian" placeholder="归还时间" clearable  :readonly="ro.guihaishijian"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="归还时间" prop="guihaishijian">
					<el-input v-model="ruleForm.guihaishijian" placeholder="归还时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="租车天数" prop="zuchetianshu">
					<el-input v-model="ruleForm.zuchetianshu" placeholder="租车天数" clearable  :readonly="ro.zuchetianshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="租车天数" prop="zuchetianshu">
					<el-input v-model="ruleForm.zuchetianshu" placeholder="租车天数" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="租用费用" prop="qianbaojine">
					<el-input v-model="qianbaojine" placeholder="租用费用" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.qianbaojine" label="租用费用" prop="qianbaojine">
					<el-input v-model="ruleForm.qianbaojine" placeholder="租用费用" readonly></el-input>
				</el-form-item>
...
export default {
	data() {
		...
		return {
			...
			rules: {
				...
				guihaileixing: [
					{ required: true, message: '归还类型不能为空', trigger: 'blur' },
				],
				zuhuzhanghao: [
				],
				shoujihaoma: [
				...
				zuchetianshu: [
					{ required: true, message: '租车天数不能为空', trigger: 'blur' },
					{ validator: validateIntNumber, trigger: 'blur' },
				],
				qianbaojine: [
					{ validator: validateIntNumber, trigger: 'blur' },
	...
	computed: {
		...
		qianbaojine:{
			get: function () {
				return 1*this.ruleForm.rizujiage*this.ruleForm.zuchetianshu
			}
		},
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='zuchetianshu'){
							this.ruleForm.zuchetianshu = obj[o];
							this.ro.zuchetianshu = true;
							continue;
						}
						if(o=='qianbaojine'){
            ...
            this.guihaileixingOptions = "正常归还,逾期归还,提前归还".split(',')
    ...
    // 提交
    onSubmit() {
        this.ruleForm.qianbaojine = this.qianbaojine
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `zuyongfeiyong/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.zuyongfeiyongCrossAddOrUpdateFlag = false;
						 this.parent.search();
